<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"D:\Aliases\lianmeng/app/admin\view\module\index.php";i:1515225914;s:45:"D:\Aliases\lianmeng\app\admin\view\layout.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515477828;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515477847;}*/ ?>
                    ...
                    <?php if($vo['system'] != 1): ?>
                        <div class="layui-btn-group">
                            <?php switch($vo['status']): case "0": ?>
                                    <a href="<?php echo url('install?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">安装</a>
                                ...
                                <?php break; case "1": if(config('develop.app_debug') && $vo['app_id'] == 0): ?>
                                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small red">编辑</a>
                                    <?php endif; if(!empty($vo['config'])): ?>
                                    <a href="<?php echo url('system/index?group='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-small">配置</a>
                                    <?php endif; if($vo['app_id'] > 0): ?>
                                    <a href="<?php echo url('upgrade/lists?app_type=module&app_id='.$vo['app_id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">更新</a>
                                    <?php else: endif; ?>
                                ...
                                <?php break; case "2": if(config('develop.app_debug') && $vo['app_id'] == 0): ?>
                                    ...
                                    <a href="<?php echo url('system/index?group='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-small">配置</a>
                                    <?php endif; ?>
                                    <a href="<?php echo url('theme?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">主题</a>
                                    <?php if($vo['app_id'] > 0): ?>
                                    <a href="<?php echo url('upgrade/lists?app_type=module&identifier='.$vo['identifier']); ?>" class="layui-btn layui-btn-primary layui-btn-small">更新</a>
                                    <?php else: endif; ?>
                                    <a href="<?php echo url('uninstall?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">卸载</a>
