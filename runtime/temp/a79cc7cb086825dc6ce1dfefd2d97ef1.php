<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"D:\Aliases\lianmeng/app/admin\view\content\edit.php";i:1515650655;s:45:"D:\Aliases\lianmeng\app\admin\view\layout.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515477828;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515477847;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="type_id" class="field-role_id" type="select">
                ...
                <?php echo $vo['id']==$data['type_id']?'selected' : ''; ?>
                ><?php echo $vo['level']; ?><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" value="<?php echo $data['title']; ?>" name="title" lay-verify="title" autocomplete="off" placeholder="请输入标题内容">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" value="<?php echo $data['author']; ?>" name="author" lay-verify="title" autocomplete="off" placeholder="请输入作者名称">
        </div>
        <div class="layui-form-mid layui-word-aux"></div>
    </div>
    <!--图片-->
