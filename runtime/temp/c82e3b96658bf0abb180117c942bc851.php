<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"D:\Aliases\lianmeng/app/admin\view\plugins\index.php";i:1515225914;s:45:"D:\Aliases\lianmeng\app\admin\view\layout.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515477828;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515477847;}*/ ?>
                    ...
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <?php switch($vo['status']): case "0": ?>
                                    ...
                                    <?php if($vo['app_id'] == 0): ?>
                                    <!-- <a data-href="<?php echo url('package?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-ajax">打包</a> -->
                                    <?php endif; ?>
                                ...
                                <?php break; case "1": ?>
                                    ...
                                    <?php if($vo['app_id'] > 0): ?>
                                    <a href="<?php echo url('upgrade/lists?app_type=plugins&app_id='.$vo['app_id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">更新</a>
                                    <?php else: ?>
                                    <!-- <a data-href="<?php echo url('package?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-ajax">打包</a> -->
                                    <?php endif; ?>
