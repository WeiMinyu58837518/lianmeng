<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"D:\Aliases\lianmeng/app/admin\view\type\edit.php";i:1515482031;s:45:"D:\Aliases\lianmeng\app\admin\view\layout.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515477828;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515225914;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515477847;}*/ ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid" class="field-role_id" type="select">
                ...
                <?php if($vol['id'] == $data['pid']): ?> selected<?php endif; ?>
                ><?php echo $vol['level']; ?><?php echo $vol['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <input type="hidden" name="idd" class="" value="<?php echo $data['id']; ?>">
    <input type="hidden" name="status" class="" value="<?php echo $data['status']; ?>">
    <div class="layui-form-item">
        <label class="layui-form-label">分类名称</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" lay-verify="title" value="<?php echo $data['name']; ?>" autocomplete="off" placeholder="请输入分类名称">
        </div>
